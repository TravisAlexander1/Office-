...
function draw() {
  ...
  if (gs === story) {
    ...
    strokeWeight(3);
    fill("lightgrey");
    text("Travis goes to his coding Office, usually", 140, 170);
    ...
    text("Travis's speed increases every time he", 40, 475);
    ...
    stroke("blue");
    fill("white");
    text("Travis Thanks you",260,350);
    ...
    text("help Travis, reach",280,490);
